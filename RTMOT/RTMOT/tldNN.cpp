...
void tldNN::dotldNN(float* x,int n,int M,float* pex,int N1,float* nex,int N2,float* conf1,float* conf2,int* isin)
{
	cudaNN.calc_tldNN(x, n, M, pex, N1, nex, N2, conf1, conf2, isin);
}